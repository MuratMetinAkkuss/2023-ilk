...
public class deneme {
    ...
    public static void printArrayMethod() {
        ...
        int[] ogrencilerinYaslari = new int[size]; // burada yaptigimiz sey scanner den aldigimiz degerleri
        // array a kaydetmis olduk. artık array listesi uzerinden islem yapacagiz.
        //aldigimiz her deger array a gonderecek.
    ...
    public static void main(String[] args) {
         printArrayMethod() ; // yaslar sorusu
